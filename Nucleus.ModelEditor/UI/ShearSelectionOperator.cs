...
namespace Nucleus.ModelEditor
{
	public class ShearSelectionOperator : DefaultOperator
	{
		...
		public override void GizmoRender(EditorPanel editorPanel, IEditorType target) {
			Texture texB = EngineCore.Textures.LoadTextureFromFile("models/gizmo_shear_base.png");
			Texture texX = EngineCore.Textures.LoadTextureFromFile("models/gizmo_shear_dirX.png");
			Texture texY = EngineCore.Textures.LoadTextureFromFile("models/gizmo_shear_dirY.png");
			float size = 96f;
			...
			Graphics2D.DrawTexturedRectangle(new Vector2F(-(size * 2f) / 2f), new(size * 2f));
