...
namespace Nucleus.ModelEditor.UI
{
	public static class EditorDialogs
	{
		...
		private static void SetupDescription(Window dialog, string text) {
		...
		private static void SetupOKCancelButtons(Window dialog, bool preferOK, Action? confirmed, Action? denied) {
