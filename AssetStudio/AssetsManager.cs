...
namespace AssetStudio
{
    public class AssetsManager
    {
		...
		public void LoadAssetsFile(FileReader reader)
        {
		...
		public void LoadAssetsFromMemory(FileReader reader, string originalPath, string unityVersion = null)
        {
            if (!assetsFileListHash.Contains(reader.FileName))
            {
                try
		...
		public void LoadBundleFile(FileReader reader, string originalPath = null)
        {
            Logger.Info("Loading " + reader.FullPath);
            try
            {
		...
		public void LoadWebFile(FileReader reader)
        {
            Logger.Info("Loading " + reader.FullPath);
            try
            {
		...
		public void LoadZipFile(FileReader reader)
        {
