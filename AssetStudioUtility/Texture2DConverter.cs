...
namespace AssetStudio
{
    public class Texture2DConverter
    {
        ...
        private bool DecodeDXT1(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

        private bool DecodeDXT5(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");
        ...
        private bool DecodeBC4(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeBC5(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeBC6H(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeBC7(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");
        ...
        private bool DecodePVRTC(byte[] image_data, byte[] buff, bool is2bpp) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeETC1(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeATCRGB4(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeATCRGBA8(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");
		private bool DecodeEACR(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeEACRSigned(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");
		private bool DecodeEACRG(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeEACRGSigned(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeETC2(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeETC2A1(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeETC2A8(byte[] image_data, byte[] buff) => throw new NotImplementedException("Do it yourself!");

		private bool DecodeASTC(byte[] image_data, byte[] buff, int blocksize) => throw new NotImplementedException("Do it yourself!");
        ...
        private bool UnpackCrunch(byte[] image_data, out byte[] result) => throw new NotImplementedException("Do it yourself!");
    }
}
