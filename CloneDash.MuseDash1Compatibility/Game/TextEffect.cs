...
namespace CloneDash.Game
{
	...
	public class TextEffect : Entity
	{
		...
		public override void PostRender(FrameState frameState) {
			...
			var finalPos = Position / MuseDash1Game.GlobalScale;
			...
			Rlgl.Translatef((finalPos.X / 1.68f) - (pos0to1_two * (frameState.WindowWidth * 0.06f / MuseDash1Game.GlobalScale)), (-finalPos.Y / 2) - pos, 0);
