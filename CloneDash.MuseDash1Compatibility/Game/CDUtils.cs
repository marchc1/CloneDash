...
public static class CDUtils
{
	...
	public static int DetermineScoreMultiplied(this MuseDash1Game game, float baseScore, PollResult pollResult) => DetermineScoreMultiplied(baseScore, game.InFever, game.Combo, pollResult.DistanceToHit);
}
