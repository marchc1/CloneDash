...
namespace Nucleus.Rendering
{
	...
	public static unsafe partial class OpenGL
	{
		...
		public static void AlphaFunc(int func, float t) => _glAlphaFunc(func, t);
		...
		public static string GetString(int name) {
			var buffer = new nint(_glGetString(name));
		...
		public static string GetStringi(int name, uint index) {
			var buffer = new nint(_glGetStringi(name, index));
			return PtrToStringUtf8(buffer);
		}
		...
		///     .
		/// </param>
		public static void BufferData(int target, int size, nint data, int usage) => _glBufferData(target, new nint(size), data.ToPointer(), usage);
		...
		///     .
		/// </param>
		public static void BufferData(int target, int size, /*const*/ void* data, int usage) => _glBufferData(target, new nint(size), data, usage);
		...
		/// <param name="type">Specifies a pixel type for the returned data.</param>
		/// <param name="pixels">Returns the texture image. Should be a pointer to an array of the type specified by type.</param>
		public static void GetTexImage(int target, int level, int format, int type, nint pixels) => _glGetTexImage(target, level, format, type, pixels.ToPointer());
		...
		/// <param name="type">Specifies the data type of the pixel data.</param>
		/// <param name="pixels">A pointer where the pixel data will be written.<para>Must have enough memory allocated for the desired dimensions and pixel format.</para></param>
		public static void ReadPixels(int x, int y, int width, int height, int format, int type, nint pixels) => _glReadPixels(x, y, width, height, format, type, pixels.ToPointer());
		...
		public static void TexImage1D(int target, int level, int internalFormat, int width, int border, int format, int type, nint pixels) => _glTexImage1D(target, level, internalFormat, width, border, format, type, pixels.ToPointer());
		...
		/// </param>
		/// <param name="pixels">Specifies a pointer to the image data in memory.</param>
		public static void TexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format, int type, nint pixels) => _glTexImage2D(target, level, internalFormat, width, height, border, format, type, pixels.ToPointer());
		...
		/// </param>
		/// <param name="pixels">Specifies a pointer to the image data in memory.</param>
		public static void TexImage3D(int target, int level, int internalFormat, int width, int height, int depth, int border, int format, int type, nint pixels) => _glTexImage3D(target, level, internalFormat, width, height, depth, border, format, type, pixels.ToPointer());
		...
		/// </param>
		public static void GetCompressedTexImage(int target, int level, nint pixels) => _glGetCompressedTexImage(target, level, pixels.ToPointer());
		...
		/// </param>
		public static void WaitSync(nint sync, uint flags, ulong timeout) => _glWaitSync(sync, flags, timeout);
		...
		public static nint FenceSync(int condition, uint flags = 0) => _glFenceSync(condition, flags);
		...
		public static bool IsSync(nint sync) => _glIsSync(sync);
		...
		public static int ClientWaitSync(nint sync, uint flags, ulong timeout) => _glClientWaitSync(sync, flags, timeout);
		...
		/// <param name="type">Specifies the data type of the pixel data.</param>
		/// <param name="pixels">Specifies a pointer to the image data in memory.</param>
		public static void TexSubImage1D(int target, int level, int xOffset, int width, int format, int type, nint pixels) => _glTexSubImage1D(target, level, xOffset, width, format, type, pixels.ToPointer());
		...
		/// <param name="type">Specifies the data type of the pixel data.</param>
		/// <param name="pixels">Specifies a pointer to the image data in memory.</param>
		public static void TexSubImage2D(int target, int level, int xOffset, int yOffset, int width, int height, int format, int type, nint pixels) => _glTexSubImage2D(target, level, xOffset, yOffset, width, height, format, type, pixels.ToPointer());
		...
		public static nint MapBuffer(int target, int access) => new(_glMapBuffer(target, access));
		...
		public static void CompressedTexImage3D(int target, int level, int internalFormat, int width, int height, int depth, int border, int imageSize, nint data) => _glCompressedTexImage3D(target, level, internalFormat, width, height, depth, border, imageSize, data.ToPointer());
		...
		/// <param name="imageSize">Specifies the number of unsigned bytes of image data starting at the address specified by <paramref name="data"/>.</param>
		/// <param name="data">Specifies a pointer to the compressed image data in memory.</param>
		public static void CompressedTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int imageSize, nint data) => _glCompressedTexImage2D(target, level, internalFormat, width, height, border, imageSize, data.ToPointer());
		...
		/// <param name="imageSize">Specifies the number of unsigned bytes of image data starting at the address specified by <paramref name="data"/>.</param>
		/// <param name="data">Specifies a pointer to the compressed image data in memory.</param>
		public static void CompressedTexImage1D(int target, int level, int internalFormat, int width, int border, int imageSize, nint data) => _glCompressedTexImage1D(target, level, internalFormat, width, border, imageSize, data.ToPointer());
		...
		/// <param name="imageSize">Specifies the number of unsigned bytes of image data starting at the address specified by <paramref name="data"/>.</param>
		/// <param name="data">Specifies a pointer to the compressed image data in memory.</param>
		public static void CompressedTexSubImage3D(int target, int level, int xOffset, int yOffset, int zOffset, int width, int height, int depth, int format, int imageSize, nint data) => _glCompressedTexSubImage3D(target, level, xOffset, yOffset, zOffset, width, height, depth, format, imageSize, data.ToPointer());
		...
		/// <param name="imageSize">Specifies the number of unsigned bytes of image data starting at the address specified by <paramref name="data"/>.</param>
		/// <param name="data">Specifies a pointer to the compressed image data in memory.</param>
		public static void CompressedTexSubImage2D(int target, int level, int xOffset, int yOffset, int width, int height, int format, int imageSize, nint data) => _glCompressedTexSubImage2D(target, level, xOffset, yOffset, width, height, format, imageSize, data.ToPointer());
		...
		/// <param name="imageSize">Specifies the number of unsigned bytes of image data starting at the address specified by <paramref name="data"/>.</param>
		/// <param name="data">Specifies a pointer to the compressed image data in memory.</param>
		public static void CompressedTexSubImage1D(int target, int level, int xOffset, int width, int format, int imageSize, nint data) => _glCompressedTexSubImage1D(target, level, xOffset, width, format, imageSize, data.ToPointer());
		...
		/// <param name="indices">Specifies a pointer to the location where the indices are stored.</param>
		/// <param name="drawCount">Specifies the size of the count and indices arrays.</param>
		public static void MultiDrawElements(int mode, int[] count, int type, nint indices, int drawCount) {
		...
		public static void GetBufferSubData(int target, int offset, int size, nint data) => _glGetBufferSubData(target, new nint(offset), new nint(size), data.ToPointer());
		...
		/// <param name="size">Specifies the size in bytes of the data store region being returned.</param>
		/// <param name="data">Specifies a pointer to the location where buffer object data is returned.</param>
		public static void GetBufferSubData(int target, long offset, long size, nint data) => _glGetBufferSubData(target, new nint(offset), new nint(size), data.ToPointer());
		...
		/// <param name="size">Specifies the size in bytes of the data store region being returned.</param>
		/// <param name="data">Specifies a pointer to the location where buffer object data is returned.</param>
		public static void GetBufferSubData(int target, int offset, int size, void* data) => _glGetBufferSubData(target, new nint(offset), new nint(size), data);
		...
		/// <param name="size">Specifies the size in bytes of the data store region being returned.</param>
		/// <param name="data">Specifies a pointer to the location where buffer object data is returned.</param>
		public static void GetBufferSubData(int target, long offset, long size, void* data) => _glGetBufferSubData(target, new nint(offset), new nint(size), data);
		...
		/// <returns>A pointer to the beginning of the mapped range.</returns>
		public static nint MapBufferRange(int target, int offset, int length, uint access) => new(_glMapBufferRange(target, new nint(offset), new nint(length), access));
		...
		/// <param name="access">Specifies a combination of access flags indicating the desired access to the mapped range.</param>
		/// <returns>A pointer to the beginning of the mapped range.</returns>
		public static nint MapBufferRange(int target, long offset, long length, uint access) => new(_glMapBufferRange(target, new nint(offset), new nint(length), access));
		...
		public static void FlushMappedBufferRange(int target, int offset, int length) => _glFlushMappedBufferRange(target, new nint(offset), new nint(length));
		...
		/// <param name="offset">Specifies the start of the buffer subrange, in basic machine units.</param>
		/// <param name="length">Specifies the length of the buffer subrange, in basic machine units.</param>
		public static void FlushMappedBufferRange(int target, long offset, long length) => _glFlushMappedBufferRange(target, new nint(offset), new nint(length));
		...
		///     target.
		/// </param>
		public static void BindBufferRange(int target, uint index, uint buffer, int offset, int size) => _glBindBufferRange(target, index, buffer, new nint(offset), new nint(size));
		...
		///     target.
		/// </param>
		public static void BindBufferRange(int target, uint index, uint buffer, long offset, long size) => _glBindBufferRange(target, index, buffer, new nint(offset), new nint(size));
		...
		public static void BufferSubData(int target, int offset, int size, nint data) => _glBufferSubData(target, new nint(offset), new nint(size), data.ToPointer());
		...
		/// <param name="size">Specifies the size in bytes of the data store region being replaced.</param>
		/// <param name="data">Specifies a pointer to the new data that will be copied into the data store.</param>
		public static void BufferSubData(int target, long offset, long size, nint data) => _glBufferSubData(target, new nint(offset), new nint(size), data.ToPointer());
		...
		/// <param name="size">Specifies the size in bytes of the data store region being replaced.</param>
		/// <param name="data">Specifies a pointer to the new data that will be copied into the data store.</param>
		public static void BufferSubData(int target, int offset, int size, /*const*/ void* data) => _glBufferSubData(target, new nint(offset), new nint(size), data);
		...
		/// <param name="size">Specifies the size in bytes of the data store region being replaced.</param>
		/// <param name="data">Specifies a pointer to the new data that will be copied into the data store.</param>
		public static void BufferSubData(int target, long offset, long size, /*const*/ void* data) => _glBufferSubData(target, new nint(offset), new nint(size), data);
		...
		///     the data store of the buffer currently bound to the ARRAY_BUFFER target.
		/// </param>
		public static void VertexAttribPointer(uint index, int size, int type, bool normalized, int stride, nint pointer) => _glVertexAttribPointer(index, size, type, normalized, stride, pointer.ToPointer());
		...
		public static void CopyBufferSubData(int readTarget, int writeTarget, int readOffset, int writeOffset, int size) => _glCopyBufferSubData(readTarget, writeTarget, new nint(readOffset), new nint(writeOffset), new nint(size));
		...
		/// <param name="writeOffset">Specifies the offset, in basic machine units, within the data store of the destination buffer object at which data will be written.</param>
		/// <param name="size">Specifies the size, in basic machine units, of the data to be copied from the source buffer object to the destination buffer object.</param>
		public static void CopyBufferSubData(int readTarget, int writeTarget, long readOffset, long writeOffset, long size) => _glCopyBufferSubData(readTarget, writeTarget, new nint(readOffset), new nint(writeOffset), new nint(size));
		...
		/// <param name="stride">Specifies the byte offset between consecutive generic vertex attributes.<para>If stride is 0, the generic vertex attributes are understood to be tightly packed in the array.</para>The initial value is 0.</param>
		/// <param name="pointer">Specifies a offset of the first component of the first generic vertex attribute in the array in the data store of the buffer currently bound to the ARRAY_BUFFER target.<para>The initial value is 0.</para></param>
		public static void VertexAttribIPointer(uint index, int size, int type, int stride, nint pointer) => _glVertexAttribIPointer(index, size, type, stride, pointer.ToPointer());
		...
		public static nint GetVertexAttribPointerv(uint index, int pname) {
		...
		public static nint GetBufferPointerv(int target, int pname) {
		...
		public static void GetSynciv(nint sync, int pname, int bufSize, int* length, int* values) => _glGetSynciv(sync, pname, bufSize, length, values);
		...
		public static int[] GetSynciv(nint sync, int pname, int count, out int length) {
		...
		private static T GetDelegateForFunctionPointer<T>(nint ptr) {
			if (ptr == nint.Zero) {
				return default;
			}
