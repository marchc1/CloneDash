...
namespace Nucleus.Types
{
    public static class ShaderExtensions
    {
        ...
        public static void SetShaderValue<T>(this Shader shader, string location, T value) where T : unmanaged => SetShaderValue(shader, shader.GetShaderLocation(location), value);
