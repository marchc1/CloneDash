...
internal static unsafe partial class Raylib
{
	...
	/// </summary>
	internal const string NativeLibName = "raylib";

	/// <summary>Internal memory allocator</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void* MemAlloc(int size);

	/// <summary>Internal memory reallocator</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void* MemRealloc(void* ptr, int size);
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsAudioDeviceValid();
	...
	[LibraryImport(NativeLibName)]
	internal static partial Wave LoadWave(sbyte* fileName);

	/// <summary>Load wave from memory buffer, fileType refers to extension: i.e. "wav"</summary>
	[LibraryImport(NativeLibName)]
	internal static partial Wave LoadWaveFromMemory(sbyte* fileType, byte* fileData, int dataSize);

	/// <summary>Checks if wave data is ready</summary>
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsWaveValid(Wave wave);

	/// <summary>Load sound from file</summary>
	[LibraryImport(NativeLibName)]
	internal static partial Sound LoadSound(sbyte* fileName);
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsSoundValid(Sound sound);

	/// <summary>Update sound buffer with new data</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void UpdateSound(Sound sound, void* data, int sampleCount);
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool ExportWave(Wave wave, sbyte* fileName);

	/// <summary>Export wave sample data to code (.h)</summary>
	[LibraryImport(NativeLibName)]
	internal static partial CBool ExportWaveAsCode(Wave wave, sbyte* fileName);
	...
	[LibraryImport(NativeLibName)]
	internal static partial int GetSoundsPlaying();

	/// <summary>Check if a sound is currently playing</summary>
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsSoundPlaying(Sound sound);
	...
	[LibraryImport(NativeLibName)]
	internal static partial void WaveCrop(Wave* wave, int initSample, int finalSample);

	/// <summary>Convert wave data to desired format</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void WaveFormat(Wave* wave, int sampleRate, int sampleSize, int channels);

	/// <summary>Get samples data from wave as a floats array</summary>
	[LibraryImport(NativeLibName)]
	internal static partial float* LoadWaveSamples(Wave wave);

	/// <summary>Unload samples data loaded with LoadWaveSamples()</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void UnloadWaveSamples(float* samples);

	// Music management functions

	/// <summary>Load music stream from file</summary>
	[LibraryImport(NativeLibName)]
	internal static partial Music LoadMusicStream(sbyte* fileName);

	/// <summary>Load music stream from memory buffer, fileType refers to extension: i.e. ".wav"</summary>
	[LibraryImport(NativeLibName)]
	internal static partial Music LoadMusicStreamFromMemory(sbyte* fileType, byte* data, int dataSize);

	/// <summary>Checks if a music stream is ready</summary>
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsMusicValid(Music music);
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsMusicStreamPlaying(Music music);
	...
	internal static void SeekMusicStream(Music music, float position) {
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsAudioStreamValid(AudioStream stream);
	...
	[LibraryImport(NativeLibName)]
	internal static partial void UpdateAudioStream(AudioStream stream, void* data, int frameCount);

	/// <summary>Check if any audio stream buffers requires refill</summary>
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsAudioStreamProcessed(AudioStream stream);
	...
	[LibraryImport(NativeLibName)]
	internal static partial CBool IsAudioStreamPlaying(AudioStream stream);
	...
	[LibraryImport(NativeLibName)]
	internal static partial void SetAudioStreamCallback(
		AudioStream stream,
	...
	[LibraryImport(NativeLibName)]
	internal static partial void AttachAudioStreamProcessor(
		AudioStream stream,
	...
	[LibraryImport(NativeLibName)]
	internal static partial void DetachAudioStreamProcessor(
		AudioStream stream,
		delegate* unmanaged[Cdecl]<void*, uint, void> processor
	);
	...
	[LibraryImport(NativeLibName)]
	internal static partial void AttachAudioMixedProcessor(
		delegate* unmanaged[Cdecl]<void*, uint, void> processor
	);

	/// <summary>Detach audio stream processor from the entire audio pipeline</summary>
	[LibraryImport(NativeLibName)]
	internal static partial void DetachAudioMixedProcessor(
		delegate* unmanaged[Cdecl]<void*, uint, void> processor
	);
}
