...
{
	private static readonly ThreadLocal<byte[]> localTextBuffs = new(() => new byte[1024 * 1024]);
	...
	public abstract bool CheckDirectory(ReadOnlySpan<char> path, FileAccess? specificAccess = null, FileMode? specificMode = null);
